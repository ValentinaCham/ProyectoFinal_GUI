...
public class Juego extends JFrame{
    ...
    private void createContents(){
        ...
        //JLabel LblTurnos = new JLabel("Partida Número "+ contadorTurnos, SwingConstants.CENTER);
    ...
    private void pregwin() {
        if(ManoDerecha1.getDedos() == 0 && ManoIzquierda1.getDedos() == 0) {
            JOptionPane.showMessageDialog(this, "GANO JUGADOR NÚMERO 2", "GANADOR!!", JOptionPane.INFORMATION_MESSAGE);
            //contador++;
            dispose();
            Juego ventana = new Juego(cantidadDedos, contadorTurnos);
        }
        else if (ManoDerecha2.getDedos() == 0 && ManoIzquierda2.getDedos() == 0){
            JOptionPane.showMessageDialog(this, "GANO JUGADOR NÚMERO 1", "GANADOR!!", JOptionPane.INFORMATION_MESSAGE);
            dispose();
            Juego ventana = new Juego(cantidadDedos, contadorTurnos);
        }
    }
    ...
    private void adicionar() {
        ...
        //entonces turno=false(0) es equipo 1 y si primeraMano es true entonces tienen que estar actvivadas los de la manoderecha1 y manoizquierda1
